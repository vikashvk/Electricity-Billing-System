...
import com.ebs.security.RestAuthenticationEntryPoint;
import com.ebs.security.TokenAuthenticationFilter;
import com.ebs.security.UserDetailsServiceImpl;
import com.ebs.security.oauth2.CustomOAuth2UserService;
import com.ebs.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.ebs.security.oauth2.OAuth2AuthenticationFailureHandler;
...
<<<<<<< Updated upstream
				.antMatchers("/", "/error").permitAll().antMatchers("/auth/**", "/oauth2/**").permitAll().anyRequest()
=======
				.antMatchers("/", "/error").permitAll().antMatchers("/auth/**","/payment/**", "/oauth2/**","/api/**").permitAll().anyRequest()
>>>>>>> Stashed changes
